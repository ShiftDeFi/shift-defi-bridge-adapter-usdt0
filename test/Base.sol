...
abstract contract Base is Test {
    ...
    function _setUp(Fork memory _l1Fork, Fork memory _l2Fork) internal {
        ...
        l1Peer.setOAppAndPeerAllowance(l2Fork.eid, address(l2Fork.oft), address(l2Peer), true);
        vm.stopPrank();
        ...
        l2Peer.setOAppAndPeerAllowance(l1Fork.eid, address(l1Fork.oft), address(l1Peer), true);
        vm.stopPrank();
